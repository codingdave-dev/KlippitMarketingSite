...
const Newsletter = () => {
  ...
  const handleSendEmail = (e) => {
    ...
    emailjs.sendForm('service_p3jhxth', 'template_c9jfpja', e.target, 'user_9kwgXPTXfJBBQ0qX8byRw')
        .then((result) => {
        ...
        <form onSubmit={handleSendEmail}>
          <Grid item container alignItems={"center"}>
            ...
            <Grid item style={{ marginLeft: "5px" }}>
              <Button variant="contained" color={"primary"} size={"medium"} type={'submit'} disabled={submitting}>
                Subscribe
              </Button>
            </Grid>
          </Grid>
